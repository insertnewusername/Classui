        ...
        return [
            {
                ...
                title: 'Welcome',
                icon: 'Home Icon.svg',
                thumbnail: 'Welcome.jpeg',
                content: [
                    { type: 'text', text: 'Welcome to Modern Classroom!' },
                    { type: 'text', text: 'Use the navigation bar below to explore all of the features available to you' },
                    { type: 'text', text: 'You can customise things such as the sidebar appearanca and background using the tabs at the top of the settings page.' },
                ]
            },
            {
                id: 'dark-mode',
            ...
            },
            {
                ...
                thumbnail: 'Classroom Colour.jpeg',
                content: [
